...
Further analyses could yield a more effective predictor, and possibly improve the algorithm's performance. Some possible courses of action I could take include:
   ...
   3. Reducing the dimensions of my data to focus solely on weather or departing airports, in order to gain a more informative look at how certain features affect my predictions and precision.
